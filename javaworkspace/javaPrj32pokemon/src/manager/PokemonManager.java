...
public class PokemonManager {
	...
	private void setEnemyPokemon() {
		int num = MyUtil.getRandomInt(1, 3);  //랜덤값
		switch(num) {
		case 1 : Main.enemyPokemon = new Pokemon(Pokemon.NAME01); break; //(포켓몬 이름, 체력, 공격력, 방어력)
	...
	private void setUserPokemon(int num) {
		switch(num) {
		case 1 : Main.userPokemon = new Pokemon(Pokemon.NAME01); break; //(포켓몬 이름, 체력, 공격력, 방어력)
